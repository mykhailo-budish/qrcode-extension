require("./qr-decoder/grid.js");
require("./qr-decoder/version.js");
require("./qr-decoder/detector.js");
require("./qr-decoder/formatinf.js");
require("./qr-decoder/errorlevel.js");
require("./qr-decoder/bitmat.js");
require("./qr-decoder/datablock.js");
require("./qr-decoder/bmparser.js");
require("./qr-decoder/datamask.js");
require("./qr-decoder/rsdecoder.js");
require("./qr-decoder/gf256poly.js");
require("./qr-decoder/gf256.js");
require("./qr-decoder/decoder.js");
require("./qr-decoder/qrcode.js");
require("./qr-decoder/findpat.js");
require("./qr-decoder/alignpat.js");
require("./qr-decoder/databr.js");
...
function QCodeDecoder() {
   ...
   */
  QCodeDecoder.isCanvasSupported = function() {
   ...
   */
  QCodeDecoder.hasGetUserMedia = function() {
   ...
   * provided.
   */
  QCodeDecoder._prepareCanvas = function(videoElem) {
    if (!this.canvasElem) {
   ...
   * @return {Object}      this
   */
  QCodeDecoder._captureToCanvas = function(videoElem, cb, once) {
   ...
   *                              error
   */
  QCodeDecoder.decodeFromCamera = function(videoElem, cb, once) {
  ...
  QCodeDecoder.decodeFromVideo = function(videoElem, cb, once) {
    setTimeout(
      function() {
        this._captureToCanvas.call(this, videoElem, cb, once);
      }.bind(this),
   ...
   * @return {Object}             this
   */
  QCodeDecoder.decodeFromImage = function(img, cb) {
   ...
   * the current default)
   */
  QCodeDecoder.setSourceId = function(sourceId) {
    if (sourceId)
   ...
   */
  QCodeDecoder.getVideoSources = function(cb) {
    var sources = [];
